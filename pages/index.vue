...
// Variables reactivas para formulario
const correo = ref('')
...
// Cookie donde guardas el usuario logueado
const userLogin = useCookie<Login | null>('user')

// Al montar la página, si ya hay token => a /inicio
onMounted(() => {
...
// Indica que use el layout "auth" (sin NavBar/SideBar)
definePageMeta({
  layout: 'auth',
})
</script>
